...
public class Food : Entity, IFood, IInventoryable
{
    ...
    public void Consume(double amount)
    {
        ...
        if (amount > Quantity)
            throw new ArgumentException("Not enough food available", nameof(amount));
    ...
    {
        return $"{Name}, Type: {Type}, Quantity: {Quantity}kg, Expires: {ExpirationDate.ToShortDateString()}";
    }
}